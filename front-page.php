      ...
      <h2 class="headline headline--small-plus t-center">From Our Blogs</h2>
        ...
        $homepagePosts = new WP_Query( array(
            ...
            while($homepagePosts->have_posts()) {
                ...
                <div class="event-summary">
                    <a class="event-summary__date event-summary__date--beige t-center" href="<?php permalink_link() ?>">
                    <span class="event-summary__month"><?php the_time( 'M' )?></span>
                    <span class="event-summary__day"><?php the_time( 'd' )?></span>  
                    </a>
                    <div class="event-summary__content">
                    <h5 class="event-summary__title headline headline--tiny"><a href="<?php permalink_link() ?>"><?php the_title() ?></a></h5>
                    <p><?php echo wp_trim_words(get_the_content(), 18) ?> <a href="<?php permalink_link() ?>" class="nu gray">Read more</a></p>
                    </div>
                </div>
                <?php
            } wp_reset_postdata();
